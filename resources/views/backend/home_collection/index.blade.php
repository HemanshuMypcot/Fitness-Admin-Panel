                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2" id="listing-filter-data" style="display: none;">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select class="required select2 form-control" id="search_collection_type" name="search_collection_type" style="width: 100% !important;">
                                            ...
                                            <table class="table table-bordered table-striped  datatable" id="dataTable" width="100%" cellspacing="0" data-url="home_collection/fetch">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        @if($data['home_collection_edit'] || $data['home_collection_view'] || $data['home_collection_status'])

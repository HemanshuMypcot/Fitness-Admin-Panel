            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-sm-7">
                                    <h5 class="pt-2">Edit Course: {{$course['course_name']}} ({{ config('translatable.locales_name')[\App::getLocale()] }}) - {{$course['sku_code']}}</h5>
                                </div>
                        ...
                        <div class="card-body">
                            <form id="savecoursecategory" method="post" action="course/update">
                    			@csrf
                                            ...
                                            <div id="payment" class="tab-pane fade">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input class="form-control required allow_numeric" type="number" id="amount" value="{{$course['amount']}}" name="amount" min=0><br/>
                                                    </div>
                                                    <div class="col-sm-6">

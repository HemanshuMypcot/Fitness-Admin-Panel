                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-sm-7">
                                    <h5 class="pt-2">View Course Category: {{$course_category['category_name']}} ({{ config('translatable.locales_name')[\App::getLocale()] }})</h5>
                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered">
                                                    <tr>
                                                        ...
                                                        <td>{{ $course_category->nick_name ?? ''}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Sequence</strong></td>
                                                        <td>{{ $course_category->sequence ?? ''}}</td>
                                                    </tr>
                                                    @if(isset($media))
                                                    <tr>
                                                        ...
                                                        <table class="table table-striped table-bordered">
                                                            <?php foreach ($translated_block as $translated_block_fields_key => $translated_block_fields_value) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $course_category[$translated_block_fields_key.'_'.$translated_data_tabs] ?? '' ?></td>
                                                                    </tr>
                                                            <?php } ?>
                                                        </table>
                                                    </div>

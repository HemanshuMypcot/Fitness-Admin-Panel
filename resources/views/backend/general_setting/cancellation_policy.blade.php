                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-header">
                                        <h4 class="card-title text-center">Cancellation Policy</h4>
                                    </div>
                                    <div class="card-body">
                                        <form id="editCancellationPolicy" method="post" action="cancellation_policy/update">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="pull-right">
                                                        <button type="button" class="btn btn-success" onclick="submitEditor('editCancellationPolicy','post')">Save Changes</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>

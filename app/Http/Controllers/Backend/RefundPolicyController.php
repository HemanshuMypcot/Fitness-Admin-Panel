...
class RefundPolicyController extends Controller
{
    ...
    {
        $data['data'] = Policy::where('type', 'refund_policy')->first();
        $data['refund_policy_view'] = checkPermission('refund_policy_view');
        $data['refund_policy_edit'] = checkPermission('refund_policy_edit');
        ...
        return view('backend/general_setting/refund_policy',$data);
    }
    ...
    public function update(Request $request)
    {
        try{
            DB::beginTransaction();
            $data = Policy::where('type', 'refund_policy')->first();
            $input=$request->all();
